...
class SpisokOrg extends StatelessWidget {
  final spiskOrg = <SpisokOrgan>[
    SpisokOrgan(
        ...
        whatsp: ''),
    SpisokOrgan(
        title: 'Хатын-Арынская ДШИ',
        nazv: 'Детская школа искусств с.Аппаны',
        logo: 'images/logo02.png',
        poln:
            'Муниципальная бюджетная организация дополнительного образования «Хатын-Арынская детская школа искусств муниципального образования "Намский улус" Республики Саха (Якутия)»',
        rukov: 'Директор: Колесова Александра Аркадьевна',
        adres:
            '678388, Республика Саха(Якутия), Намский улус, село Аппаны, улица Д.Сивцева, 4',
        telf: '8 (41162) 2-34-35',
        email: 'namskmuzscool@mail.ru',
        wwwad: '',
    ...
    SpisokOrgan(
        ...
        poln:
            'Муниципальное бюджетное учреждение "Звукостудия «Хатычаан» с.Аппаны муниципального образования "Хатын-Арынский наслег" Намского улуса Республики Саха (Якутия)"',
